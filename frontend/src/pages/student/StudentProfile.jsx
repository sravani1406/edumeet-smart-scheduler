      ...
      <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <p className="text-lg text-gray-900 bg-gray-50 p-3 rounded-lg">{profile.name}</p>
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-600 mb-1">Email Address</label>
            <p className="text-lg text-gray-900 bg-gray-50 p-3 rounded-lg">{profile.email}</p>
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-600 mb-1">Phone Number</label>
            <p className="text-lg text-gray-900 bg-gray-50 p-3 rounded-lg">{profile.phone || "Not provided"}</p>
          </div>
        ...
        <p className="text-sm text-gray-500 mt-6 italic">* Profile details are fixed and cannot be edited</p>
      </div>
